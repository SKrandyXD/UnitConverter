...
from converters.converters_gui.base_converter_gui import BaseConverterGUI


class LinearConverterGUI(BaseConverterGUI):
    def __init__(self, converter: LinearConverter):
